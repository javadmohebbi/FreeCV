<div id="modalAddEdu" class="modal fade" >
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" style="overflow-y: auto;width: 100%;">
                ...
                <div class="col-sm-12 form-group form-inline">
                    ...
                    <select id="edu-from_month" name="edu-from_month"
                ...
                <div class="col-sm-12 form-group form-inline">
                    ...
                    <select id="edu-to_month" name="edu-to_month"
                            class="form-control col-sm-12">
                        <option value="1">{{trans('ocv.month_1')}}</option>
                        <option value="2">{{trans('ocv.month_2')}}</option>
                        <option value="3">{{trans('ocv.month_3')}}</option>
                    ...
                    <label style="cursor: pointer">
                        <input type="checkbox" data-checked="null" class="form-control" id="edu-is_present" name="edu-is_present" value=""/>
                ...
                <div class="col-sm-12 form-group">
                    ...
                    {{ Form::textarea('edu-new-proj-description',null,
                                   array('class' => 'summernote',
                                        'id' => "edu-new-proj-description",
            ...
            <div class="modal-footer">
                ...
                <button id="btnSaveNewEdu" type="button" class="submit btn btn-primary">
                    {{ trans('ocv.save') }}
                </button>
