<section id="projectSection" class="content"  style="background: white">
    <!-- BEGIN Project -->
    <h1 id="projects">
        <i class="fa fa-cubes"></i>
        {{ trans('ocv.projects') }}
        @if(checkIfAdmin())
            <a id="btnAddNewProject"
               href="javascript:void(0);"
               class="btn btn-danger"/>
            <i class="fa fa-plus"></i>
            {{ trans('ocv.add') }}
            </a>
            <img class="prj-loading hidden" src="{{ asset('public/img/ajax-loader.gif') }}" alt="loading"/>
            <!--<input id="isProjectEnabled"  checked data-toggle="toggle" data-size="normal" type="checkbox">-->
        @endif

    </h1>
    @if (count(getProjects()->toArray()) <= 0)
    <ul class="timeline hidden" id="project-timeline" style="direction: ltr"></ul>
    @else
    <ul class="timeline" id="project-timeline" style="direction: ltr">
...
@include('templates.modals.modal-project-add')


<!-- Edit Project Modal -->
@include('templates.modals.modal-project-edit')