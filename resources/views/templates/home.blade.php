...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        @include('templates.sections.bio')
        @endif
        ...
        @include('templates.sections.skills')
        @endif

        <!-- Experiences -->
        @if (isExperiencesActive(App::getLocale()))
        @include('templates.sections.experiences')
        @endif

        <!-- Contacts -->
        @if (isContactActive(App::getLocale()))
        @include('templates.sections.contacts')
        @endif


        <!-- Knowledge Base -->
        @if (isKbActive(App::getLocale()))
        @include('templates.sections.kb')
        @endif

        <!-- User Management Modal -->
        @include('templates.modals.modal-users')
