...
return [
    ...
    */
    ...
    'attributes'           => [
        ...
        'corporate_name' => 'نام',
        'desc' => 'شرح',
        'slug' => 'نام مناسب برای موتورهای جست و جو',
        'summary' => 'خلاصه',
        'enabled' => 'فعال',
        'priority' => 'اولویت',
        'parent_category_id' => 'مادر',
        'article_category_id' => 'دسته',
        'unit_kind' => 'نوع سرویس',
        'fee' => 'فی',
        'price' => 'قیمت',
        'promotion_price' => 'قیمت در تخفیف',
        ...
        'city_id' => 'شهر',
        'isCmsUser' => 'کاربر پورتال',
        'disabled' => 'غیرفعال',

        'oldpassword' => 'کلمه عبور پیشین',
        'corporate_email' => 'ایمیل',
        'corporate_tell' => 'تلفن',
        'corporate_mobile' => 'موبایل',
        'corporate_address' => 'آدرس',
        'corporate_website' => 'وبسایت',
        'servicelevel_id' => 'سطوح خدمات',
        'employee' => 'تعداد کارمندان',
        'employees' => 'تعداد کارمندان',
        'organization_type' => 'سایز شرکت/سازمان',
        'organization_category' => 'نوع شرکت/سازمان',
        'web_title' => 'عنوان',
        'web_keywords' => 'کلمات کلیدی',
        'web_desc' => 'شرح',
        'contact_email' => 'ایمیل',
        'contact_tell' => 'تلفن',
        'contact_fax' => 'فکس',
